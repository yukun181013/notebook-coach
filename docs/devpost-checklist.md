...
- [x] Pre-generated full-loop example contains no challenge answers.
- [x] Local deterministic test suite passes.
...
- [x] Fresh detached checkout installs on Python 3.11 (13.34 seconds at equivalent rewritten commit `5d231b4`).
